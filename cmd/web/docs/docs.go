...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/rbac/user-roles/{user_id}/{role_id}": {
            "delete": {
                "security": [
                    {
                        "SessionAuth": []
        ...
        "/api/resource-management/summary": {
            "get": {
                "security": [
                    {
                        "SessionAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Counts and summary fields",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/vhf/cif": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Missing or invalid case_code",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/vhf/lab/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Case or patient ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/vhf/patients/{id}/clinical-signs": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Clinical signs payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/vhf/patients/{id}/hospitalization": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Hospitalization payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/vhf/patients/{id}/investigator": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Investigator payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/vhf/patients/{id}/laboratory": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Laboratory payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/vhf/patients/{id}/risk-factors": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Risk factors payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Credentials (required for JSON requests)",
                        "name": "credentials",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Login successful (JSON mode); includes redirect path for the web app",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
